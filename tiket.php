<?php
    ...
    $p = mysqli_fetch_object($permintaan);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<button type="button" class="btn btn-info"><a href="cetak-tiket.php?idorder= <?= $t->order_id ?>" style="color: #111; font-size: 20px; text-decoration:none;" >cetak voucher</a></button>
    <div class="e-tiket">
    <div class="tiket">
        ...
        <div class="body-tiket">
            ...
            <div  class="maaps">
            <iframe src="<?= $t->google_maps ?>" width="450" height="200" style="border:0;"  allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
                    ...
                    <?php
                            ...
                            $c = mysqli_fetch_object($cek);
                                ...
                                echo "asu";
                                    ...
                                    echo "<td class='bold'> $p->tipe_ranjang </td>"; 
                                }
                            ?>    
                    </tr>
                </table>
