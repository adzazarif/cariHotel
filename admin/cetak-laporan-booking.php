...
<body>
    ...
    <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                <?php
                $cetak = mysqli_query($conn, "SELECT * FROM reservasi LEFT JOIN pelanggan USING (id_pelanggan) LEFT JOIN hotel USING (id) WHERE  tgl_kedatangan BETWEEN '".$_POST['mulai']."' AND '".$_POST['sampai']."' ");
